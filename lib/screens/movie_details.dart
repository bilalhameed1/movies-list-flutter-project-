...
class MovieDetails extends StatelessWidget {
  const MovieDetails({super.key, required this.movie}); //required this.movie});
  final Movie movie;
  ...
  Widget build(BuildContext context) {
    ...
    if (movie.backdropPath == null && movie.posterPath == null) {
      portraitImage = Image.asset(noImage,
        width: double.infinity,
        height: size.height / 2.4,
        fit: BoxFit.cover,
      );
      landscapeImage = Image.asset(noImage,
        width: size.width / 3,
        height: 350,
        fit: BoxFit.cover,
      );
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: size.width < 600
            ? Column( // will render when app is in landscape mode
          ...
          children: [
            ...
            : Row( // will render when app is in landscape mode
          children: [
          landscapeImage,
          const SizedBox(
            width: 20,
